...
if ($config['description']) {
	...
	content="<?php echo htmlspecialchars($config['description']);?>" />
			<?php
}

if ($config['keywords']) {
    ?><meta name="keywords"
	content="<?php echo htmlspecialchars($config['keywords']);?>" />
			<?php
}

if ($config['generator']) {
    ?><meta name="generator"
	content="<?php echo htmlspecialchars($config['generator']);?>" />
			<?php
}

if ($config['icon']) {
    ?><link rel="icon"
	type="image/<?php echo end(explode('.', ($config['icon'])));?>"
	href="<?php echo $config['icon']?>" />
			<?php
}
?>
